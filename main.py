...
class Application:
    ...
    def _init_controller(self) -> None:
        ...
        # En el futuro, aquí se podría usar un factory pattern
        # para seleccionar el controlador según el OS
    ...
    def _schedule_next_switch(self) -> None:
        """
        Programa el siguiente cambio de ventana.
        Se llama recursivamente mientras el servicio esté activo.
        """
